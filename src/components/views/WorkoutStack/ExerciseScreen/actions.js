...
export const show_var = payload => {
  console.log("I am in the action of the show_var is : ", payload);
  return {
    type: "showing_var",
    payload: payload
  };
      ...
      for (var index in payload.data) {
        ...
        switch (row.key) {
          ...
          case "time":
            ...
            break;
          case "resttime":
            let rest_time_value = row.acheived == "" ? "0" : row.acheived;
            set.accomplished_rest_time = String(rest_time_value);
            break;
